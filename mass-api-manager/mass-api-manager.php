...
add_shortcode('mam_bing_images', function ($attr, $content) {
    ...
    if (count($images) > 0) {
        // $result = '<div class="bing_image_table_container"><table class="bing_image_table"><tr>';
        // foreach ($images as $image) {
        //     $result .= '<td><img class="pb-seo_lazy" src="' . $image . '" alt=""></td>';
        // }
        // $result .= '</tr></table></div>';
        // return $result;
        ...
        <div class="tab-pane container fade" id="settings">
            <div class="section" id="general-settings">
                ...
                <dl class="section-settings">
                    ...
                    <dd>
                        <div class="checkbox-row"><input type="checkbox" value="yep" name="" id="mam_delete_firstline">
                    ...
                    <dd>
                        <div class="checkbox-row"><input type="checkbox" value="yep" name="" id="mam_delete_lastline">
